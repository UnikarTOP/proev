          ...
          <div className="max-w-[1120px] mx-auto px-4 md:px-6 py-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {[['О проекте','/about'],['Контакты','/contacts'],['Водителям','/for-drivers'],['База EV','/ev-catalog'],['Операторам ЭЗС','/operators'],['Сообщество','/community'],['Планировщик маршрута','/route-planner'],['Политика конфиденциальности','/privacy'],['Пользовательское соглашение','/terms']].map(([l,h]) => (
                    <a key={h} href={h} className="block text-sm text-muted hover:text-ink-900 transition-colors">{l}</a>
                  ))}
                </div>
              </div>
