  ...
  return (
    <div className="max-w-[740px] mx-auto px-4 md:px-6 py-10 md:py-14">
      ...
      <a href="https://go.sravni.ru/aff_c?aff_id=101339&offer_id=1064&source=10640&out=https%3A%2F%2Fwww.sravni.ru%2Fosago%2F%3F" target="_blank" rel="noopener noreferrer sponsored"
        className="flex items-center gap-4 bg-gradient-to-r from-[#0B4DB8] to-[#1565D8] rounded-2xl p-5 no-underline hover:opacity-95 transition-opacity mt-8">
        ...
        <span className="flex-shrink-0 bg-white text-[#0B4DB8] text-xs font-bold px-4 py-2 rounded-xl">Рассчитать →</span>
      </a>
